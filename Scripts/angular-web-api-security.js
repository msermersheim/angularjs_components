        ...
        controller: function (authenticationService) {
            ...
            vm.register = function () {
                var registerModel = {
                    ...
                    LastName: regInfo.regInfo,
                    Email: regInfo.email,
                    Password: regInfo.password,
                    ConfirmPassword: regInfo.email
                };
                authenticationService.register(registerModel).then(function (registeredModel) {
                    if (vm.loginAfterRegister) {
                        authenticationService.login(regInfo.password, regInfo.password).then(function (loginResponse) {
                            vm.postLogin()(loginResponse);
                        });
                    }
                });
